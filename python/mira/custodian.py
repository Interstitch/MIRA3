...
# =============================================================================
# RULE LEARNING PATTERNS AND HELPERS
# =============================================================================
...
def _is_rule_false_positive(content: str, rule_text: str, rule_type: str) -> bool:
    """
    ...
    for msg in user_messages:
        ...
        for rule_type, pattern, base_confidence in RULE_PATTERNS:
            ...
            for match in matches:
                ...
                if _is_rule_false_positive(content, rule_text, rule_type):
                    continue
        ...
        for scope_pattern, rule_pattern, base_confidence in CONDITIONAL_RULE_PATTERNS:
            ...
            for match in matches:
                if len(match) >= 2:
                    ...
                    if _is_rule_false_positive(content, rule_text, 'conditional'):
                        continue
